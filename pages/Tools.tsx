...
import { Type, Settings, Sparkles, ChevronRight, ArrowLeft, Box, Download, FileText, Lightbulb, GraduationCap } from 'lucide-react';
...
import CgpaCompanion from '../tools/cgpa-companion/index';
...
export const TOOLS_DATA: Tool[] = [
  {
    id: 'cgpa-companion',
    name: 'CGPA Companion',
    description: 'Calculate semester and cumulative GPA with professional reports.',
    instructions: "Track your academic performance semester by semester. Add your courses, input grades (letter or marks), and instantly get your SGPA and CGPA. You can even download a detailed PDF report for your records.",
    category: 'utility',
    icon: GraduationCap,
    component: <CgpaCompanion />,
    path: 'cgpa-companion'
  },
  {
    id: 'text-converter',
  ...
  },
  {
    ...
    instructions: "Writing for the web? Markdown is the standard, but it's hard to visualize in your head. Type on the left side, and see exactly how it will look on the right. It's the fastest way to bridge the physical and digital worlds.",
    category: 'text',
    icon: Type,
